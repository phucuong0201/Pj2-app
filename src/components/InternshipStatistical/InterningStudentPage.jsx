...
import './InterningStudentPage.css';

const InterningStudentPage = React.createClass({
  render() {
    return (
      <div className="container">
        <h5 className="title"><i className="fa fa-clock-o"></i> Interning Student</h5>
            ...
            <div className="row">
              <table>
                <tr>
                  ...
                  <th className="col-md-1">Time Left</th>
                </tr>
              </table>
            </div>
          </div>
...
export default InterningStudentPage;